...
public class Write30 {

	private static final Logger LOGGER = Logger.getLogger(Frame1.class.getName());
	public void write30(String s, String market_Name, String antennaBandwidth, int rownum, XSSFWorkbook workbook1, XSSFSheet sheet1, int rowHeader, String numvalue, String nameOfReadFile)
	{
		try
		{
			LOGGER.setLevel(Level.ALL);
			LOGGER.info("Inside/Write30");
			...
			for (int i = 1; i < 2; i++) {
				...
				{
					LOGGER.log(Level.SEVERE, "Inside/NullPointerException", a);
					LOGGER.info("Inside/NullPointerException");
					continue;
				}
